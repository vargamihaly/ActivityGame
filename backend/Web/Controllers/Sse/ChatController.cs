...
//             new
//             {
//                 messageId = savedMessage.Id, userId = savedMessage.SenderId, content = savedMessage.Content, timestamp = savedMessage.Timestamp,
//             }
//         );
//
//         return Ok(new ApiResponse<ChatMessageResponse>
//         {
//             Success = true, Data = mapper.Map<ChatMessageResponse>(savedMessage),
//         });
//     }
//
//     [HttpGet("messages")]
...
//         {
//             Success = true, Data = mapper.Map<List<ChatMessageResponse>>(history),
//         });
//     }
// }
